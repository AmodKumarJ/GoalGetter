...
const Edit = () => {
  ...
  return (
    <div className="bg-slate-100 absolute w-[40%] p-3 h-[60%] z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-md rounded-[10px] flex justify-center items-center flex-col">
      ...
      <form className="w-[90%] flex flex-col gap-2">
        ...
        <div>
          <label htmlFor="">Priority and Category</label>
        </div>
        <div className="flex gap-2">
          <div className="w-1/2">
